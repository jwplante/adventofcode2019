...
class Vector:
    # Constructor
    def __init__(self, startPt, mag_direc):
    ...
    def __str__(self):
        return "Vector(" + str(self.startPt) + ", " + str(self.endPt) + ", " + self.mag_direc + ", " + str(self.isHorizontal) + ")"
...
def getVectorArray(wires):
    ...
    for direction_string in wires.split(','):
        current_vector = Vector(initial_point , direction_string)
